...
class RejectSessionsScreen extends StatefulWidget {
  const RejectSessionsScreen({super.key});

  @override
  State<RejectSessionsScreen> createState() => _RejectSessionsScreenState();
}

class _RejectSessionsScreenState extends State<RejectSessionsScreen> {
  late Stream<QuerySnapshot> usersStream;

  @override
  void initState() {
    super.initState();
    final CollectionReference canceld = FirebaseFirestore.instance
        .collection('Parent')
        .doc(FirebaseAuth.instance.currentUser!.uid)
        .collection('RejuctAndCanceld');
    Query query = canceld.where('status', isEqualTo: 'canceld');
