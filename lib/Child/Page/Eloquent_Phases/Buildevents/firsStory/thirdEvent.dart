...
class thirdEvent extends StatefulWidget {
  final String childId;
  final String page;
  const thirdEvent({required this.childId, required this.page});

  @override
  State<thirdEvent> createState() => _thirdEventState();
}

class _thirdEventState extends State<thirdEvent> {
  //usageRate varible-----------
