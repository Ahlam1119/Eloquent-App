...
class fourthEvent extends StatefulWidget {
  ...
  final String page;
  fourthEvent({required this.childId, required this.page});

  @override
  State<fourthEvent> createState() => _fourthEventState();
}

class _fourthEventState extends State<fourthEvent> {
  //usageRate varible-----------
