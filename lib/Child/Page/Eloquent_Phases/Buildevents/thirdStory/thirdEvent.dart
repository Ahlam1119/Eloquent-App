...
import 'package:eloquentapp/Child/Page/Eloquent_Phases/Buildevents/thirdStory/fourthEvent.dart';
...
class thirdEventThird extends StatefulWidget {
  final String childId;
  final String page;
  const thirdEventThird({required this.childId, required this.page});

  @override
  State<thirdEventThird> createState() => _thirdEventThirdState();
}

class _thirdEventThirdState extends State<thirdEventThird> {
  //usageRate varible-----------
