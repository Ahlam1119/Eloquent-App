...
class firstEventThird extends StatefulWidget {
  ...
  final String page;
  const firstEventThird({required this.childId, required this.page});

  @override
  State<firstEventThird> createState() => _firstEventThirdState();
}

class _firstEventThirdState extends State<firstEventThird> {
  //usageRate varible-----------
