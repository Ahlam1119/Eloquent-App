...
class secondEventThird extends StatefulWidget {
  final String childId;
  final String page;
  const secondEventThird({required this.childId, required this.page});

  @override
  State<secondEventThird> createState() => _secondEventThirdState();
}

class _secondEventThirdState extends State<secondEventThird> {
  //usageRate varible-----------
