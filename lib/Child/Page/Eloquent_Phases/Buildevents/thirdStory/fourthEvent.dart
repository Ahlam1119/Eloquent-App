...
import 'package:eloquentapp/Child/Page/Eloquent_Phases/Buildevents/thirdStory/thirdEvent.dart';
import 'package:flutter/material.dart';
import 'package:assets_audio_player/assets_audio_player.dart';
import 'package:audioplayers/audioplayers.dart';

class fourthEventThird extends StatefulWidget {
  final String childId;
  final String page;
  fourthEventThird({required this.childId, required this.page});

  @override
  State<fourthEventThird> createState() => _fourthEventThirdState();
}

class _fourthEventThirdState extends State<fourthEventThird> {
  //usageRate varible-----------
