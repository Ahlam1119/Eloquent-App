...
class sixthEventFourth extends StatefulWidget {
  ...
  final String page;
  const sixthEventFourth({required this.childId, required this.page});

  @override
  State<sixthEventFourth> createState() => _sixthEventFourthState();
}

class _sixthEventFourthState extends State<sixthEventFourth> {
  //usageRate varible-----------
