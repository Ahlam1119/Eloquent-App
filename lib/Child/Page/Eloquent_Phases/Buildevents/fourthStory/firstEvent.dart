...
import 'package:eloquentapp/Child/Page/Eloquent_Phases/Buildevents/secStory/secEventSec.dart';
import 'package:eloquentapp/Child/Page/Eloquent_Phases/Buildingconcepts.dart';
import 'package:flutter/material.dart';
import 'package:assets_audio_player/assets_audio_player.dart';
import 'package:audioplayers/audioplayers.dart';

class firstEventFourth extends StatefulWidget {
  final String childId;
  final String page;
  const firstEventFourth({required this.childId, required this.page});

  @override
  State<firstEventFourth> createState() => _firstEventFourthState();
}

class _firstEventFourthState extends State<firstEventFourth> {
  //usageRate varible-----------
