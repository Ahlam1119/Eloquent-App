...
import 'package:eloquentapp/Child/Page/Eloquent_Phases/Buildevents/fourthStory/sixthEvent.dart';
import 'package:flutter/material.dart';
import 'package:assets_audio_player/assets_audio_player.dart';
import 'package:audioplayers/audioplayers.dart';

class fifthEventFourth extends StatefulWidget {
  final String childId;
  final String page;
  const fifthEventFourth({required this.childId, required this.page});

  @override
  State<fifthEventFourth> createState() => _fifthEventFourthState();
}

class _fifthEventFourthState extends State<fifthEventFourth> {
  //usageRate varible-----------
