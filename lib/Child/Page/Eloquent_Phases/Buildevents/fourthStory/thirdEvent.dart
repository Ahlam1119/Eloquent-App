...
class thirdEventFourth extends StatefulWidget {
  ...
  final String page;
  const thirdEventFourth({required this.childId, required this.page});

  @override
  State<thirdEventFourth> createState() => _thirdEventFourthState();
}

class _thirdEventFourthState extends State<thirdEventFourth> {
  //usageRate varible-----------
