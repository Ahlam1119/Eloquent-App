...
class secEventFourth extends StatefulWidget {
  ...
  final String page;
  const secEventFourth({required this.childId, required this.page});

  @override
  State<secEventFourth> createState() => _secEventFourthState();
}

class _secEventFourthState extends State<secEventFourth> {
  //usageRate varible-----------
