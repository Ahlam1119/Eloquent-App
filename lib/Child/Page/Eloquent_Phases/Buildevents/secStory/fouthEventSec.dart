...
class fouthEventSec extends StatefulWidget {
  ...
  final String page;
  const fouthEventSec({required this.childId, required this.page});

  @override
  State<fouthEventSec> createState() => _fouthEventSecState();
}

class _fouthEventSecState extends State<fouthEventSec> {
  //usageRate varible-----------
