...
class thirdEventSec extends StatefulWidget {
  final String childId;
  final String page;
  const thirdEventSec({required this.childId, required this.page});

  @override
  State<thirdEventSec> createState() => _thirdEventSecState();
}

class _thirdEventSecState extends State<thirdEventSec> {
  //usageRate varible-----------
