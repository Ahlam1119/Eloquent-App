...
class firstEventSec extends StatefulWidget {
  final String childId;
  final String page;
  const firstEventSec({required this.childId, required this.page});

  @override
  State<firstEventSec> createState() => _firstEventSecState();
}

class _firstEventSecState extends State<firstEventSec> {
  //usageRate varible-----------
