...
class secEventSec extends StatefulWidget {
  final String childId;
  final String page;
  const secEventSec({required this.childId, required this.page});

  @override
  State<secEventSec> createState() => _secEventSecState();
}

class _secEventSecState extends State<secEventSec> {
  //usageRate varible-----------
