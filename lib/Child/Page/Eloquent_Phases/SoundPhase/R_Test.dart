...
class R_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  R_Test_Page({required this.childId, required this.page});
  @override
  State<R_Test_Page> createState() => _R_Test_PageState();
}

class _R_Test_PageState extends State<R_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/ra.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/rw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/re.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
