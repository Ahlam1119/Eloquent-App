...
class E_Test_Page extends StatefulWidget {
  final String childId;
  final String page;
  //1
  E_Test_Page({required this.childId, required this.page});
  @override
  State<E_Test_Page> createState() => _E_Test_PageState();
}

class _E_Test_PageState extends State<E_Test_Page> {
  //usageRate varible-----------
