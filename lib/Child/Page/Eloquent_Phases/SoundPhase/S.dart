...
class S_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  S_sound({required this.childId, required this.page});
  @override
  State<S_sound> createState() => _S_soundState();
}

class _S_soundState extends State<S_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Saa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaS.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => S_Test_Page(
                              childId: ChildID, page: 'S_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
