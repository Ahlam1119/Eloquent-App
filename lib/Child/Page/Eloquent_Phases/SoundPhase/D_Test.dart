...
class D_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  D_Test_Page({required this.childId, required this.page});
  @override
  State<D_Test_Page> createState() => _D_Test_PageState();
}

class _D_Test_PageState extends State<D_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/da.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/dw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/de.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
