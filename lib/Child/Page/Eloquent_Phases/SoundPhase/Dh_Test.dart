...
class Dha_Test_Page extends StatefulWidget {
  //1 حرف ض
  final String childId;
  final String page;
  Dha_Test_Page({required this.childId, required this.page});
  @override
  State<Dha_Test_Page> createState() => _Dha_Test_PageState();
}

class _Dha_Test_PageState extends State<Dha_Test_Page> {
  //usageRate varible-----------
