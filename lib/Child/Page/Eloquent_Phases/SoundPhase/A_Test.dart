...
class A_Test_Page extends StatefulWidget {
  final String childId;
  final String page;
  A_Test_Page({required this.childId, required this.page});
  @override
  State<A_Test_Page> createState() => _A_Test_PageState();
}

class _A_Test_PageState extends State<A_Test_Page> {
  //usageRate varible-----------
  ...
  //   final int randomIndex = Random().nextInt(soundPaths.length);
  //   final String randomSoundPath = soundPaths[randomIndex];

  //   final AssetsAudioPlayer assetsAudioPlayer = AssetsAudioPlayer();
  //   assetsAudioPlayer.open(
  //     Audio(randomSoundPath),
  //     autoStart: true,
  //     showNotification: true,
  //   );
  // }

  // bool isCorrectAA = false;
  // bool isCorrectAW = false;
  // bool isCorrectAY = false;
//-------------------------------------
  final List<String> soundPaths = [
    "images/AASounds.wav",
    "images/Aw.wav",
