...
class EE_Test_Page extends StatefulWidget {
  final String childId;
  final String page;
  //1
  EE_Test_Page({required this.childId, required this.page});
  @override
  State<EE_Test_Page> createState() => _EE_Test_PageState();
}

class _EE_Test_PageState extends State<EE_Test_Page> {
  //usageRate varible-----------
