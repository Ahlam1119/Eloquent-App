...
class HH_sound extends StatefulWidget {
  final String childId;
  final String page;
  //2
  HH_sound({required this.childId, required this.page});
  @override
  State<HH_sound> createState() => _HH_soundState();
}

class _HH_soundState extends State<HH_sound> {
  //usageRate varible-----------
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      width: 93,
                                      height: 93,
                                      child: Image.asset("images/Haa.png"),
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Haa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                        width: 93,
                                        height: 93,
                                        child: Image.asset("images/aHa.png")),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/meet.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaH.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => HH_Test_Page(
                              childId: ChildID, page: 'HH_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
