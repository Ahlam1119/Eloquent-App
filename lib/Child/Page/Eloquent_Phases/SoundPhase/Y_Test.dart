...
class Y_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  Y_Test_Page({required this.childId, required this.page});
  @override
  State<Y_Test_Page> createState() => _Y_Test_PageState();
}

class _Y_Test_PageState extends State<Y_Test_Page> {
  //usageRate varible-----------
