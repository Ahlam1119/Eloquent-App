...
class Z_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  Z_Test_Page({required this.childId, required this.page});
  @override
  State<Z_Test_Page> createState() => _Z_Test_PageState();
}

class _Z_Test_PageState extends State<Z_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/za.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/zw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/ze.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
