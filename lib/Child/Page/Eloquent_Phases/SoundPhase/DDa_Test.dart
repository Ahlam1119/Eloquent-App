...
//حرف ظ
class DDa_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  DDa_Test_Page({required this.childId, required this.page});
  @override
  State<DDa_Test_Page> createState() => _DDa_Test_PageState();
}

class _DDa_Test_PageState extends State<DDa_Test_Page> {
  //usageRate varible-----------
