...
class K_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  K_Test_Page({required this.childId, required this.page});
  @override
  State<K_Test_Page> createState() => _K_Test_PageState();
}

class _K_Test_PageState extends State<K_Test_Page> {
  //usageRate varible-----------
