...
//حرف ض
class Ta_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  Ta_sound({required this.childId, required this.page});

  @override
  State<Ta_sound> createState() => _Ta_soundState();
}

class _Ta_soundState extends State<Ta_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/TAaa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aTAa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaTA.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
