...
class H_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  H_Test_Page({required this.childId, required this.page});
  @override
  State<H_Test_Page> createState() => _H_Test_PageState();
}

class _H_Test_PageState extends State<H_Test_Page> {
  //usageRate varible-----------
