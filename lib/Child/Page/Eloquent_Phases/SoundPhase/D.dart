...
class D_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  D_sound({required this.childId, required this.page});
  @override
  State<D_sound> createState() => _D_soundState();
}

class _D_soundState extends State<D_sound> {
  //usageRate varible-----------
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aDa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaD.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => D_Test_Page(
                              childId: ChildID, page: 'D_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
