...
import 'package:eloquentapp/Child/Page/Eloquent_Phases/SoundPhase/Dh_Test.dart'; //1
...
import 'DDa_Test.dart';
import 'Ta_Test.dart';

//حرف ظ
class DDa_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  DDa_sound({required this.childId, required this.page});
  @override
  State<DDa_sound> createState() => _DDa_soundState();
}

class _DDa_soundState extends State<DDa_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/DDaaa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aDDa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaDD.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DDa_Test_Page(
                              childId: ChildID, page: 'DDa_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
