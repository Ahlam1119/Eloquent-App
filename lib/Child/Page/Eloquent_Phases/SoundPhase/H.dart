...
class H_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  H_sound({required this.childId, required this.page});
  @override
  State<H_sound> createState() => _H_soundState();
}

class _H_soundState extends State<H_sound> {
  //usageRate varible-----------
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aHa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => H_Test_Page(
                              childId: ChildID, page: 'H_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
