...
class HH_Test_Page extends StatefulWidget {
  final String childId;
  final String page;
  //1
  HH_Test_Page({required this.childId, required this.page});
  @override
  State<HH_Test_Page> createState() => _HH_Test_PageState();
}

class _HH_Test_PageState extends State<HH_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/7a.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/7w.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/7e.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
