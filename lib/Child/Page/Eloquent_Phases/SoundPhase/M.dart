...
class M_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  M_sound({required this.childId, required this.page});
  @override
  State<M_sound> createState() => _M_soundState();
}

class _M_soundState extends State<M_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Maa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaM.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => M_Test_Page(
                              childId: ChildID, page: 'M_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
