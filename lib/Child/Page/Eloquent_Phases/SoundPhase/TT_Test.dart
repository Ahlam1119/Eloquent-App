...
class TT_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  TT_Test_Page({required this.childId, required this.page});
  @override
  State<TT_Test_Page> createState() => _TT_Test_PageState();
}

class _TT_Test_PageState extends State<TT_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/tta.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/ttw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/tte.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
