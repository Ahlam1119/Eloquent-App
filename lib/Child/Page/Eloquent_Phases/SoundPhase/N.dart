...
class N_sound extends StatefulWidget {
  final String childId;
  final String page;
  N_sound({required this.childId, required this.page});
  //2

  @override
  State<N_sound> createState() => _N_soundState();
}

class _N_soundState extends State<N_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Naa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        height: 93,
                                        child:
                                            Image.asset("images/rabbit1.png")),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaN.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => N_Test_Page(
                              childId: ChildID, page: 'N_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
