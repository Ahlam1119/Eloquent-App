...
class F_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  F_sound({required this.childId, required this.page});
  @override
  State<F_sound> createState() => _F_soundState();
}

class _F_soundState extends State<F_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Faa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/telephone.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => F_Test_Page(
                              childId: ChildID, page: 'F_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
