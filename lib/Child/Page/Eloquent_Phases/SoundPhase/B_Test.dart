...
class B_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  B_Test_Page({required this.childId, required this.page});
  @override
  State<B_Test_Page> createState() => _B_Test_PageState();
}

class _B_Test_PageState extends State<B_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/ba.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/bw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/be.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
