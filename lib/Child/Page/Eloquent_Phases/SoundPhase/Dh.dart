...
//حرف ض
class Dha_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  Dha_sound({required this.childId, required this.page});

  @override
  State<Dha_sound> createState() => _Dha_soundState();
}

class _Dha_soundState extends State<Dha_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/DHaa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aDHaa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaDH.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Dha_Test_Page(
                              childId: ChildID, page: 'Dha_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
