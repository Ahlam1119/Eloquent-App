...
class KH_Test_Page extends StatefulWidget {
  final String childId;
  final String page;
  //1
  const KH_Test_Page({required this.childId, required this.page});
  @override
  State<KH_Test_Page> createState() => _kh_Test_PageState();
}

class _kh_Test_PageState extends State<KH_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/5a.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/5w.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/5e.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
