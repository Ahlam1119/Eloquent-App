...
class W_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  W_sound({required this.childId, required this.page});
  @override
  State<W_sound> createState() => _W_soundState();
}

class _W_soundState extends State<W_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Waa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                        width: 93,
                                        height: 93,
                                        child: Image.asset("images/aWa.png")),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aWa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaW.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => W_Test_Page(
                              childId: ChildID, page: 'W_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
