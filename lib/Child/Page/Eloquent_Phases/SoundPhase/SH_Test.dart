...
class SH_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  SH_Test_Page({required this.childId, required this.page});
  @override
  State<SH_Test_Page> createState() => _SH_Test_PageState();
}

class _SH_Test_PageState extends State<SH_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  final List<String> soundPaths = [
    "images/LetterSounds/sha.wav",
    "images/LetterSounds/shw.wav",
    "images/LetterSounds/she.wav"
  ];
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/sha.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/shw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/she.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
