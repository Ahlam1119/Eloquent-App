...
class N_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  N_Test_Page({required this.childId, required this.page});
  @override
  State<N_Test_Page> createState() => _N_Test_PageState();
}

class _N_Test_PageState extends State<N_Test_Page> {
  //usageRate varible-----------
