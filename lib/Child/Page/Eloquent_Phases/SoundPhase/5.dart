...
class kh_sound extends StatefulWidget {
  final String childId;
  final String page;
  //2
  kh_sound({required this.childId, required this.page});
  @override
  State<kh_sound> createState() => _KH_soundState();
}

class _KH_soundState extends State<kh_sound> {
  //usageRate varible-----------
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      width: 93,
                                      height: 93,
                                      child: Image.asset("images/KHaa.png"),
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/5aa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                        width: 93,
                                        height: 93,
                                        child: Image.asset("images/aKHa.png")),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/a5a.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aa5.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => KH_Test_Page(
                              childId: ChildID, page: 'KH_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
