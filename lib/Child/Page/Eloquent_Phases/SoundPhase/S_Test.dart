...
class S_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  S_Test_Page({required this.childId, required this.page});
  @override
  State<S_Test_Page> createState() => _S_Test_PageState();
}

class _S_Test_PageState extends State<S_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/sa.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/sw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/se.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
