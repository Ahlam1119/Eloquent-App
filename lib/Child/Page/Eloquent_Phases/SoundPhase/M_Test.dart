...
class M_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  M_Test_Page({required this.childId, required this.page});
  @override
  State<M_Test_Page> createState() => _M_Test_PageState();
}

class _M_Test_PageState extends State<M_Test_Page> {
  //usageRate varible-----------
