...
class T_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  T_Test_Page({required this.childId, required this.page});
  @override
  State<T_Test_Page> createState() => _T_Test_PageState();
}

class _T_Test_PageState extends State<T_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/ta.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/tw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/te.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
