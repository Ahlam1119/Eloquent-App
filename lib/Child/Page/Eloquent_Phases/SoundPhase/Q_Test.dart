...
class Q_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  Q_Test_Page({required this.childId, required this.page});
  @override
  State<Q_Test_Page> createState() => _Q_Test_PageState();
}

class _Q_Test_PageState extends State<Q_Test_Page> {
  //usageRate varible-----------
