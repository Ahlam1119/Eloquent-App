...
class B_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  B_sound({required this.childId, required this.page});
  @override
  State<B_sound> createState() => _B_soundState();
}

class _B_soundState extends State<B_sound> {
  //usageRate varible-----------
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      width: 93,
                                      height: 93,
                                      child: Image.asset("images/BigDoor.png"),
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/bab.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                        width: 93,
                                        height: 93,
                                        child: Image.asset("images/aBa.png")),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aBa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaB.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => B_Test_Page(
                              childId: ChildID, page: 'B_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
