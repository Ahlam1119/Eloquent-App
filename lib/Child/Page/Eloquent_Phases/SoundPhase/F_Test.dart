...
class F_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  F_Test_Page({required this.childId, required this.page});
  @override
  State<F_Test_Page> createState() => _F_Test_PageState();
}

class _F_Test_PageState extends State<F_Test_Page> {
  //usageRate varible-----------
