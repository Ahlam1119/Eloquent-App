...
class SS_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  SS_Test_Page({required this.childId, required this.page});
  @override
  State<SS_Test_Page> createState() => _SS_Test_PageState();
}

class _SS_Test_PageState extends State<SS_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/ssa.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/ssw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/sse.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
