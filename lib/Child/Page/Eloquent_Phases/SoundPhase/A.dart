...
import 'package:eloquentapp/Child/Page/Eloquent_Phases/SoundPhase/A_Test.dart';
...
class A_sound extends StatefulWidget {
  final String childId;
  final String page;
  A_sound({required this.childId, required this.page});

  @override
  State<A_sound> createState() => _A_soundState();
}

class _A_soundState extends State<A_sound> {
  //usageRate varible-----------
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      width: 70,
                                      height: 70,
                                      child: Image.asset("images/rabbit1.png"),
                                    ),
                                  ],
                                ),
                              ),
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Aaa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        height: 86,
                                        child:
                                            Image.asset("images/BigDoor.png")),
                                  ],
                                ),
                              ),
                            ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/dawa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => A_Test_Page(
                              childId: ChildID, page: 'A_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
