...
class J_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  J_Test_Page({required this.childId, required this.page});
  @override
  State<J_Test_Page> createState() => _J_Test_PageState();
}

class _J_Test_PageState extends State<J_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/ja.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/jw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/je.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
