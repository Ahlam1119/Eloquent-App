...
class TH_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  TH_Test_Page({required this.childId, required this.page});
  @override
  State<TH_Test_Page> createState() => _TH_Test_PageState();
}

class _TH_Test_PageState extends State<TH_Test_Page> {
  //usageRate varible-----------
...
//-------------------------------------2
  ...
  void playSound() {
    ...
    switch (currentSoundPath) {
      case "images/LetterSounds/tha.wav":
        correctIndex = 0;
        soundsPlayed[0] = true;
        break;
      case "images/LetterSounds/thw.wav":
        correctIndex = 1;
        soundsPlayed[1] = true;
        break;
      case "images/LetterSounds/the.wav":
        correctIndex = 2;
        soundsPlayed[2] = true;
        break;
      default:
