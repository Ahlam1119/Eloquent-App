...
class K_sound extends StatefulWidget {
  //2
  final String childId;
  final String page;
  K_sound({required this.childId, required this.page});
  @override
  State<K_sound> createState() => _K_soundState();
}

class _K_soundState extends State<K_sound> {
  //usageRate varible-----------
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/Kaa.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  AssetsAudioPlayer.newPlayer().open(
                                    Audio("images/WordSounds/aaK.wav"),
                                    autoStart: true,
                                    showNotification: true,
                                  );
                                },
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => K_Test_Page(
                              childId: ChildID, page: 'K_Test_Page'),
                        ));
                  },
                  child: Text('التالي'),
                ),
