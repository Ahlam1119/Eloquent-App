...
class W_Test_Page extends StatefulWidget {
  //1
  final String childId;
  final String page;
  W_Test_Page({required this.childId, required this.page});
  @override
  State<W_Test_Page> createState() => _W_Test_PageState();
}

class _W_Test_PageState extends State<W_Test_Page> {
  //usageRate varible-----------
