...
class LetterYA extends StatefulWidget {
  late String childId;
  LetterYA({required this.childId});

  @override
  State<LetterYA> createState() => _LetterYAState();
}

class _LetterYAState extends State<LetterYA> {
  ...
  void _loadValues() async {
    try {
      ...
      if (snapshot.exists) {
        setState(() {
          final checkboxesMap = snapshot.get('ي'); //هنا يتم تغير الحرف
