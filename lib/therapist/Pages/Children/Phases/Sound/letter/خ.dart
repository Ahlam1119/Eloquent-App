...
class LetterKh extends StatefulWidget {
  late String childId;
  LetterKh({required this.childId});

  @override
  State<LetterKh> createState() => _LetterKhState();
}

class _LetterKhState extends State<LetterKh> {
  ...
  void _loadValues() async {
    try {
      ...
      if (snapshot.exists) {
        setState(() {
          final checkboxesMap = snapshot.get('خ'); //هنا يتم تغير الحرف
