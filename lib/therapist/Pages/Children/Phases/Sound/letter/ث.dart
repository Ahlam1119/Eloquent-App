...
class LetterTh extends StatefulWidget {
  late String childId;
  LetterTh({required this.childId});

  @override
  State<LetterTh> createState() => _LetterThState();
}

class _LetterThState extends State<LetterTh> {
  ...
  void _loadValues() async {
    try {
      ...
      if (snapshot.exists) {
        setState(() {
          final checkboxesMap = snapshot.get('ث'); //هنا يتم تغير الحرف
