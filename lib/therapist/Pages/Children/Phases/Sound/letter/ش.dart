...
class LetterSh extends StatefulWidget {
  late String childId;
  LetterSh({required this.childId});

  @override
  State<LetterSh> createState() => _LetterShState();
}

class _LetterShState extends State<LetterSh> {
  ...
  void _loadValues() async {
    try {
      ...
      if (snapshot.exists) {
        setState(() {
          final checkboxesMap = snapshot.get('ش'); //هنا يتم تغير الحرف
