...
class LetterTha extends StatefulWidget {
  late String childId;
  LetterTha({required this.childId});

  @override
  State<LetterTha> createState() => _LetterThaState();
}

class _LetterThaState extends State<LetterTha> {
  ...
  void _loadValues() async {
    try {
      ...
      if (snapshot.exists) {
        setState(() {
          final checkboxesMap = snapshot.get('ذ'); //هنا يتم تغير الحرف
